...
//        showWarmUp = false;
    ...
    void setup() {
        ...
        bg.loadImage(imagesFolder+"thermobg.png");
        mask.loadImage(imagesFolder+"thermomask.png");
        good.loadImage(imagesFolder+"krul.png");
        bad.loadImage(imagesFolder+"kruis.png");
